<template>
  <div class="follower-container">
    ...
    <template v-if="page.total">
      <div v-for="item in dataSource" class="follower-item flex-middle-between">
...
import { getUserFans, follow } from "@/api/apiManagement/userManagement";
